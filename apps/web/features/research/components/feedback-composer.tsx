      ...
      <form className="mt-5 space-y-4" onSubmit={handleSubmit}>
        <div className="space-y-2">
          ...
          <textarea
            ...
            className="min-h-32 w-full border-0 bg-surface-container-lowest px-4 py-4 text-base leading-7 text-primary placeholder:text-tertiary outline-none focus-visible:outline focus-visible:outline-2 focus-visible:outline-primary transition focus:bg-surface-container-high focus:shadow-inset-caret disabled:cursor-not-allowed disabled:opacity-70"
            disabled={isDisabled}
            id="feedback-text"
