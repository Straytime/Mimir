  ...
  if (status === "error" || blobUrl === null) {
    return (
      <div className="bg-surface-container-high p-4">
        ...
        <button
          className="mt-4 bg-transparent px-4 py-2 text-sm font-semibold text-primary shadow-ghost transition hover:shadow-glow-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-primary disabled:cursor-not-allowed disabled:text-tertiary disabled:shadow-none"
