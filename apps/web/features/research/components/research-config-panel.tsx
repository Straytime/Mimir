      ...
      >
        ...
        {hintCopy !== null && hintLabel !== null ? (
          <div
            ...
            className="absolute inset-x-0 top-full z-10 mt-1.5 bg-surface-container-low px-2.5 py-2 text-[11px] leading-5 text-secondary outline outline-1 outline-outline-variant/15"
            role="note"
          >
